...
public class FormSubmissionSteps extends TestHelper {
    ...
    public void the_package_and_forms_should_have_the_correct_info() throws Throwable {
        ...
        Document storedPackage = mongoHelper.getPackageByPackageId(PACKAGE_JSON_ID);
        ...
        FindIterable<Document> forms = mongoHelper.getFormsCollectionByPackageId(PACKAGE_JSON_ID);
